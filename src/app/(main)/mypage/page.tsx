      ...
      <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
        ...
        <div className="px-6 pb-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-end gap-4 -mt-10">
            <div className="w-20 h-20 rounded-full border-4 border-white bg-gray-100 overflow-hidden flex-shrink-0">
              {imageUrl ? (
          ...
          <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
            {profile.business_type && (
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[11px] text-gray-400">업종</p>
                  <p className="text-sm font-medium text-gray-800">{getBusinessTypeLabel(profile.business_type)}</p>
                </div>
              </div>
            )}
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm font-medium text-gray-800">{getRegionLabel(profile.region)}</p>
              </div>
            </div>
            ...
            {profile.website && (
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[11px] text-gray-400">웹사이트</p>
                  <a href={profile.website} target="_blank" rel="noopener noreferrer" className="text-sm font-medium text-primary hover:underline">{profile.website}</a>
                </div>
              </div>
            )}
          ...
          {profile.bio && (
            <div className="mt-5 pt-5 border-t border-gray-100">
              <p className="text-[11px] text-gray-400 mb-1.5">소개</p>
          ...
          <div className="mt-5 pt-5 border-t border-gray-100 flex flex-wrap gap-2">
            <Link href={ROUTES.MYPAGE_EDIT} className="text-sm text-gray-500 hover:text-primary transition-colors flex items-center gap-1.5">
            ...
            <Link href={ROUTES.MYPAGE_PASSWORD} className="text-sm text-gray-500 hover:text-primary transition-colors flex items-center gap-1.5">
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
