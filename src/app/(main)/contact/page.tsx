    ...
    <div className="max-w-[900px] mx-auto space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="card p-6 text-center">
          ...
          <h3 className="text-base font-black text-text-primary mb-1">이메일 문의</h3>
        ...
        <div className="card p-6 text-center">
          ...
          <h3 className="text-base font-black text-text-primary mb-1">전화 문의</h3>
      ...
      <div className="card p-6 md:p-8">
        <h2 className="text-lg font-black text-text-primary mb-4">자주 묻는 질문</h2>
