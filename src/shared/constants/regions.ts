// 전국 시/도별 세부 지역 데이터
export const REGION_DETAILS: Record<string, { value: string; label: string }[]> = {
  seoul: [
  ...
  daegu: [
    { value: 'jung_d', label: '중구' },
    { value: 'dong_d', label: '동구' },
    { value: 'seo_d', label: '서구' },
    { value: 'nam_d', label: '남구' },
    { value: 'buk_d', label: '북구' },
  ...
  ulsan: [
    { value: 'jung_u', label: '중구' },
    { value: 'nam_u', label: '남구' },
    { value: 'dong_u', label: '동구' },
    { value: 'buk_u', label: '북구' },
    { value: 'ulju', label: '울주군' },
  ],
  sejong: [
    { value: 'sejong_city', label: '세종시 전체' },
  ],
  gangwon: [
