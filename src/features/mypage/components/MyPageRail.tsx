...
const SECTIONS: RailSection[] = [
  {
    ...
    items: [
      ...
      { href: ROUTES.MYPAGE_DASHBOARD, label: '공고 성과', icon: 'M3.75 3v11.25A2.25 2.25 0 006 16.5h2.25M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0118 16.5h-2.25m-7.5 0h7.5m-7.5 0l-1 3m8.5-3l1 3m0 0l.5 1.5m-.5-1.5h-9.5m0 0l-.5 1.5m.75-9l3-3 2.148 2.148A12.061 12.061 0 0116.5 7.605' },
    ],
  },
  {
    title: '구인구직',
    items: [
      { href: ROUTES.JOBS_NEW, label: '공고 등록', icon: 'M12 4.5v15m7.5-7.5h-15' },
  ...
  },
  {
    ...
    items: [
      ...
      { href: ROUTES.DIRECTORY_REGISTER, label: '공개 프로필', icon: 'M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z' },
    ],
  },
  {
    title: '설정',
    ...
    <>
      ...
      <nav aria-label="마이페이지 메뉴 (모바일)" className="lg:hidden -mx-4 sm:-mx-6 mb-4 px-4 sm:px-6 overflow-x-auto">
        <div className="flex gap-1.5 pb-1 whitespace-nowrap">
          {[
            { href: ROUTES.MYPAGE_DASHBOARD, label: '공고 성과' },
            { href: ROUTES.JOBS_NEW, label: '공고 등록' },
            { href: ROUTES.MYPAGE, label: '내 공고·지원' },
