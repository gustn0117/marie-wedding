...
const SECTIONS: RailSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: ROUTES.MYPAGE_RESUMES, label: '이력서 관리', icon: 'M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H6.75A2.25 2.25 0 004.5 4.5v15.75A1.5 1.5 0 006 21.75h12a1.5 1.5 0 001.5-1.5v-6zM9 13.5h6m-6 3.75h6', individualOnly: true },
...
export default function MyPageRail({ initialAccountType = null }: MyPageRailProps = {}) {
  ...
  const visibleItems = SECTIONS
    ...
    .filter((it) => {
      if (it.businessOnly) return isBusiness;
      if (it.individualOnly) return isIndividual;
      return true;
    });
  ...
  const mobileChips = [
    ...
    isIndividual && { href: ROUTES.MYPAGE_RESUMES, label: '이력서' },
